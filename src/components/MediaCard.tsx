...
export default function MediaCard({
  ...
  return (
    <div className=" ">
      <div
        className="flex h-[110px] w-[164px] flex-col items-center rounded-lg  bg-cover bg-local bg-center bg-repeat md:h-[140px] md:w-[220px] lg:h-[174px] lg:w-[280px]"
        style={{
      ...
      >
        <div className=" group/play h-full w-full hover:rounded-lg hover:bg-black/50">
          <div className=" flex   w-full justify-end bg-transparent p-2 md:px-6 md:py-4">
            <div className=" ">
              <form
                action={BookMark}
          ...
          <div className=" invisible flex   w-full items-center justify-center  group-hover/play:visible">
